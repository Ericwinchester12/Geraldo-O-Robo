...
mapa = Mapa()
msg = ""
# controla se o jogador pode continuar andando
ativo = True
# guarda o estado final da partida (ganhou ou perdeu)
resultado = ""
# bloco try para evitar crash brusco
try:
   rodando = True
   while rodando:
       clock.tick(30)
       for evento in pygame.event.get():
           ...
           if evento.type == pygame.KEYDOWN:
               # so movimenta se o jogo não acabou
               if ativo and evento.key in teclas:
                   ...
                   if not moveu:
                       ...
                       # regra de vitoria: chegar no servidor com 3 componentes
                       ...
                       # regra de derrota: acabar a energia do robo
       ...
       # altera a cor da mensagem dependendo do que aconteceu
       if msg != "":
           if resultado == "ganhou":
               cor = (0, 255, 0)
       ...
       # mostra aviso no fim do jogo
       if not ativo:
           texto_aviso = fonte.render("Fim de jogo!", True, (255, 255, 255))
           tela.blit(texto_aviso, (180, 230))
       pygame.display.flip()
