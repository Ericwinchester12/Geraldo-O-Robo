   ...
   def foi_visitada(self, lin, col):
       for pos in self.visitados:
           if pos[0] == lin and pos[1] == col:
               return True
       return False
# separei a parte visual nessa funcao para organizar melhor o codigo e limpar o loop
def desenhar_tela(geraldo, mapa, msg, ativo, resultado):
   ...
   pygame.display.flip()
# criacao das instancias do jogo
geraldo = Geraldo()
mapa = Mapa()
msg = ""
ativo = True
...
try:
   ...
   while rodando:
       ...
       # chama a funcao visual que criamos acima
